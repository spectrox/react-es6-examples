	...
	var Main = function (_React$Component) {
	    ...
	    _createClass(Main, [{
	        ...
	        value: function render() {
	            ...
	            var rows = this.state.map.map(function (cols, rowIndex) {
	                return _react2.default.createElement(
	                    'tr',
	                    { key: 'row' + rowIndex },
	                    cols.map(function (field, colIndex) {
	                        return _react2.default.createElement(
	                            'td',
	                            { key: 'row' + rowIndex + 'col' + colIndex },
	                            rowIndex == _this2.state.position.y && colIndex == _this2.state.position.x ? '😀' : _this2.getEntryIcon(field.entry)
	                        );
	                    })
	                );
	            });
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'td',
	                                { colSpan: '15' },
	                                _react2.default.createElement('input', { autoFocus: true, type: 'text', onChange: this.onCommandChange.bind(this),
	        ...
	        key: 'generateMap',
	        value: function generateMap(rowIndex, colIndex) {
	            var map = [];
	        ...
	        key: 'getRandomEntry',
	        value: function getRandomEntry() {
	            return Math.floor(Math.random() * 2) ? Math.floor(Math.random() * 5) : 0;
	        }
	    }, {
	        key: 'getEntryIcon',
	        value: function getEntryIcon(entry) {
	            switch (entry) {
	                case 4:
	                    return '💩';
	                case 3:
	        ...
	        key: 'onCommandChange',
	        value: function onCommandChange(e) {
	            this.setState({
	        ...
	        key: 'executeGoCommand',
	        value: function executeGoCommand(direction) {
	        ...
	        value: function historyUp() {
	            var historyPosition = this.state.historyPosition;
