...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_main2.default, null), document.getElementById('js-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = function (_React$Component) {
	    ...
	    _createClass(Main, [{
	            ...
	            if (this.isGameOver()) {
	                return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { href: '#', onClick: this.onStartNewGame.bind(this) },
	                        'Start new game'
	                    )
	                );
	            }

	            var rows = Object.keys(this.state.map).map(function (rowIndex) {
	                var cols = _this2.state.map[rowIndex];

	                return _react2.default.createElement(
	                    'tr',
	                    { key: 'row' + rowIndex },
	                    Object.keys(cols).map(function (colIndex) {
	                        var field = cols[colIndex];

	                        return _react2.default.createElement(
	                            'td',
	                            { key: 'col' + colIndex,
	                                onClick: _this2.onClick.bind(_this2, rowIndex, colIndex),
	                                style: _this2.getFieldStyle(field) },
	                            field.text
	                        );
	                    })
	                );
	        ...
	        key: 'getFieldStyle',
	        value: function getFieldStyle(field) {
	            if (field.opened) {
	                if (field.flag) {
	                    return {
	                        background: 'red',
	        ...
	        key: 'onStartNewGame',
	        value: function onStartNewGame() {
	            this.setState(this.getDefaultState());
	        }
	    }, {
	        key: 'onClick',
	        value: function onClick(rowIndex, colIndex, e) {
	            e.preventDefault();
	            ...
	            this.updateText(rowIndex, colIndex, this.openNeighbors(rowIndex, colIndex));
	        ...
	        key: 'hasNotOpened',
	        value: function hasNotOpened() {
	            var _this3 = this;

	            var hasNotOpened = false;

	            Object.keys(this.state.map).forEach(function (rowIndex) {
	                Object.keys(_this3.state.map[rowIndex]).forEach(function (colIndex) {
	                    if (!_this3.state.map[rowIndex][colIndex].opened && !_this3.state.map[rowIndex][colIndex].flag) {
	                        hasNotOpened = true;
	                    }
	                });
	            });
	        ...
	        key: 'isOpened',
	        value: function isOpened(rowIndex, colIndex) {
	            return this.state.map[rowIndex][colIndex].opened;
	        }
	    }, {
	        key: 'isDeadly',
	        value: function isDeadly(rowIndex, colIndex) {
	            return this.state.map[rowIndex][colIndex].flag;
	        }
	    }, {
	        key: 'open',
	        value: function open(rowIndex, colIndex) {
	        ...
	        key: 'openNeighbors',
	        value: function openNeighbors(rowIndex, colIndex) {
	            var startX = Math.max(colIndex - 1, 0);
	            var endX = Math.min(colIndex + 1, COLS - 1);
	            var startY = Math.max(rowIndex - 1, 0);
	            var endY = Math.min(rowIndex + 1, ROWS - 1);
	        ...
	        key: 'updateText',
	        value: function updateText(rowIndex, colIndex, text) {
	            var map = this.state.map;
